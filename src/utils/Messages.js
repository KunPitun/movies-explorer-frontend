export const MESSAGES = {
  ...
  addMovieErrorMessage: 'Не удалось сохранить фильм! Попробуйте ещё раз.',
  deleteMovieErrorMessage: 'Не удалось удалить фильм! Попробуйте ещё раз.',
  nameValidationMissedInputErrorMessage: 'Вы пропустили это поле.',
  nameValidationErrorMessage: 'Имя может содержать только латиницу, кириллицу, пробел или дефис.',
}